  ...
  >
    ...
    <div slot="title" class="product_title mt-4">
      <nuxt-link
        ...
        "
        class="uppercase font-lato product_tag"
        >SKU: {{ product.sku }}</nuxt-link
      >
...
import { useWishlist, useCart, cartGetters } from '@vue-storefront/odoo';
import { productGetters, useWishlist as CopiaUseWishlist } from '~/composables';
...
export default {
  ...
  setup(props) {
    ...
    const { wishlist } = CopiaUseWishlist()
